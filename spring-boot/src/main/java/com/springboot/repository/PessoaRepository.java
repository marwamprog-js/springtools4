...
public interface PessoaRepository extends JpaRepository<Pessoa, Long> {
	...
	List<Pessoa> findAllOrderId();
	
	
	/*
	 * NOME
	 * Configuração de pesquisa para consultar por partes do nome no banco. Igual ao like
	 * */
	 ...
	 * Configuração de pesquisa para consultar por partes do nome no banco. Igual ao like
	 * */
	default Page<Pessoa> findPessoaBySexoNomePage(String nome, String sexo, Pageable pageable){
		Pessoa pessoa = new Pessoa();
		pessoa.setNome(nome);
		pessoa.setSexo(sexo);
